...
{
    public class SubscriptionTitleDetailsViewModel : ViewModelBase
    {
        private SubscriptionTitle _subscriptionTitle;
        public SubscriptionTitle SubscriptionTitle
        {
            get { return _subscriptionTitle; }
            set
            {
                _subscriptionTitle = value;
